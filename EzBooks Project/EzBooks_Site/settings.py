"""
Django settings for EzBooks_Site project.
...
SECRET_KEY = '8dh+--*hl6nt!b!bdarw2py1r4y&^!=sr-abyd@0#4l=)5p2c*'
...
ROOT_URLCONF = 'EzBooks_Site.urls'
...
WSGI_APPLICATION = 'EzBooks_Site.wsgi.application'
