...
def class_page(request):
   ...
   books_exist = 0        # Begin by assuming no books exist for the user
   ...
   # Check to see if books exist yet for the user
   ...
   # If the user has no books create the user's books based on classes
   if books_exist ==0:
